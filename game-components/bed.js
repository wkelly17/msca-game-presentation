function bed(room) {
  let html = `
	<svg
	  width="260.43201"
	  height="104.05286"
	  viewBox="0 0 68.905971 27.530652"
	  id="bed"
	>
	  <defs id="defs2936" />
	  <g id="layer1" transform="translate(-42.167118,-59.624261)">
		 <g id="g7257" transform="translate(-69.995074,-57.424933)">
			<rect
			  style="
				 fill: #552200;
				 fill-opacity: 1;
			...
			<path
			  ...
			  style="
				 ...
				 stroke-opacity: 1;
			  "
			  d="m 117.105,118.47 c 0.706,-0.266 1.027,-0.353 1.628,-0.397 0.386,-0.029 1.14782,-0.0725 1.94182,-0.10348 0.829,0.122 1.39218,0.24548 2.21218,0.31148 0.83,0.067 1.658,0.108 2.485,0.13 0.829,0.022 1.658,0.023 2.489,0.011 0.826,-0.012 1.654,-0.039 2.488,-0.073 0.823,-0.034 1.65,-0.077 2.486,-0.121 0.82,-0.044 1.647,-0.09 2.485,-0.134 0.676,-0.035 0.98,0.589 1.68,0.632 0,0 -0.122,1.264 -0.244,2.529 -0.123,1.264 -0.245,2.528 -0.245,2.528 h -2.145 -2.146 -2.146 -2.147 -2.147 -2.146 -2.146 -2.146 -2.146 -2.147 c -0.173,-0.221 -0.496,-0.031 -0.371,-0.753 0.053,-0.309 -0.029,-1.023 0,-1.501 0.022,-0.38 0.152,-0.884 0.377,-1.487 0.151,-0.406 0.579,-1.018 0.783,-1.095 l 1.267,-0.477"
			/>
			<path
			id="Blanket"
			  class="${room.$blanket.inspected ? 'inspected' : null}"
			  style="
				 fill: #999999;
				 fill-opacity: 1;
				 stroke: #000000;
				 stroke-width: 0.0189094;
				 stroke-linecap: round;
				 stroke-linejoin: round;
				 stroke-miterlimit: 4;
				 stroke-dasharray: none;

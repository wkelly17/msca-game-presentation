...
<svg
	  ...
	  id="lightSwitch1"
	  class="lightSwitch1 ${room.$lightSwitch1?.lightsOff && 'switched'}"
	>
	  <defs id="defs2936">
		 <linearGradient
		 ...
		 <g id="g13721" transform="translate(67.211506,-19.031821)">
			...
			<g id="g12459" transform="translate(-4.6671448,-1.7001742)">
			  <rect
				 ...
				 ry="2.8421808e-14"
			  />
			  <g id="switchToggle" class = '${
          room.$lightSwitch1.lightsOff && room.$lightSwitch1.className
        }'>
				 <path
					id="rect12436-4"
					style="
